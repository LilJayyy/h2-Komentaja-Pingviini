...
Lolcatia en kuitenkaan päätynyt asentamaan, sillä se vei paljon tilaa koneesta, joten jätin sen pois tällä erää.
 ![lol](images/lol.png) 
...
Hieman epäselväksi jäi syy, mutta vikatilanteen kartoittaminen yllä olevilla komentosarjoilla oli erinomainen opetus. Helpommalla olisi voinut toki päästä poistamalla alkuperäinen fortune-paketti `sudo apt remove fortune` ja asentamalla komentoriviohjelma uudelleen englanninkielisellä kokoelmalla: `sudo apt install fortunes`
